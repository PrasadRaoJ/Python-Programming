...
lblInfo=Label(Tops,font=('arial',50,'bold'),text="Hotel Jp's ",fg="Steel Blue",bd=10,anchor='w')
...
def Ref():
    ...
    CostofBiryani = CoBiryani * 100
    CostPulav = CoPulav* 50
    CostEggDosa = CoEggDosa * 25


    Central_GST= (((CostofIdly+CostofDrinks+CostofDosa+CostEggDosa+CostPulav+CostofBiryani)* 2.5)/100)

    State_GST =(((CostofIdly+CostofDrinks+CostofDosa+CostEggDosa+CostPulav+CostofBiryani)* 2.5)/100)

    Total_cost = (CostofIdly+CostofDrinks+CostofDosa+CostEggDosa+CostPulav+CostofBiryani)

    CostofMeal= "Rs", str('%.2f' % (CostofIdly+CostofDrinks+CostofDosa+CostEggDosa+CostPulav+CostofBiryani))
...
lblBiryani.grid(row=0, column=0)
lblBiryani=Entry(f1, font=('arial',16,'bold'),textvariable=Biryani,bd=10,insertwidth=4,bg="white",justify='right')
lblBiryani.grid(row=0,column=1)
...
lblEggDosa= Label(f1, font=('arial', 16, 'bold'),text="EggDosa",bd=16,anchor="w")
lblEggDosa.grid(row=2, column=0)
lblEggDosa=Entry(f1, font=('arial',16,'bold'),textvariable=EggDosa,bd=10,insertwidth=4,bg="white",justify='right')
lblEggDosa.grid(row=2,column=1)
